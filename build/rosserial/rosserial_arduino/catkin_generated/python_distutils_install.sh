...
echo_and_run cd "/home/artem/ros_workspace/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/artem/ros_workspace/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/artem/ros_workspace/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
