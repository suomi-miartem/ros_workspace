...
echo_and_run cd "/home/artem/ros_workspace/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/artem/ros_workspace/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/artem/ros_workspace/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
