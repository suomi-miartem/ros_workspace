...
echo_and_run cd "/home/artem/ros_workspace/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/artem/ros_workspace/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/artem/ros_workspace/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
